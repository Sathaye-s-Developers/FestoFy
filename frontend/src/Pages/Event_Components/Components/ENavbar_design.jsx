...
const ENavbar_design = () => {
  return (
    <div>
      ...
      >
        {/* Background grid and animation layers */}
        ...
        <div className="absolute top-5 right-5 z-10">
          <Link to="/Super_admin">
            <button className="bg-purple-600 hover:bg-purple-700 text-white font-semibold px-4 py-2 rounded shadow-lg transition-all duration-300">
              Super Admin Panel
            </button>
          </Link>
        </div>
