...
const Editableevent = () => {
    ...
    const { register, handleSubmit, setValue, setError, control, watch, reset, formState: { errors } } = useForm({
        defaultValues: {
            mode: "onSubmit",
    ...
    const getEvent = async () => {
        try {
            ...
            reset({
                ...
                category: eventData.department,
                banner: [],
                StartDate: eventData.dateRange.start.split("T")[0],
                EndDate: eventData.dateRange.end.split("T")[0],
                EntryFee: eventData.price,
                Location: eventData.location,
                MaxAttendee: eventData.maxParticipants,
                MaxVoleenter: eventData.maxVolunteers,
                Visibility: eventData.visibility,
                Tags: eventData.tags || [],
                Host: eventData.organiser_name,
                Email: eventData.email,
                ContactNo: eventData.phone || ""
            });
            ...
            <div className="min-h-screen pt-24 pb-16 px-6 flex items-center justify-center">
                <div className="max-w-2xl mx-auto text-center animate-fadeInUp">
                    <div className="bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-sm rounded-3xl border border-cyan-400/20 p-12">
                        ...
                        <h1 className="text-3xl font-bold text-white mb-4">Event Updated Successfully!</h1>
