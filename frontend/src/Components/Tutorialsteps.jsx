            ...
            <div className=''>
                ...
                <div className='flex flex-col mt-10 items-center animate-fadeInUp'>
                    <div className='border-2 md:w-[44%]  p-2 rounded-[18px] border-blue-400'>
                        ...
                        <p className='text-[15px] md:text-[15px] font-bold text-pink-300 mt-1'>(Requests will only be accepted from the Head of Department <br/> or Event In-charge (Teaching Staff)) </p>
                    </div>
                    ...
                    <div className='border-2 md:w-[44%]  p-2 rounded-[18px] border-blue-400'>
                        ...
                        <p className='text-[14px] font-bold text-pink-300 mt-1'>(When your information is verified,<br/> the result will be sent to you) </p>
                    </div>
                </div>
            </div>
        </div>
